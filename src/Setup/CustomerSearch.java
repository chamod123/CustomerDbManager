...
public class CustomerSearch extends javax.swing.JInternalFrame {
    ...
    private void load_block() {
        try {
            ResultSet set = blockData.getBlock();
            set.last();
            set.beforeFirst();
            while (set.next()) {
                String block_no = set.getString("block_no");
                block_select.addItem(block_no);
            }
            set.close();
            set = null;
    ...
    private void ShowGrid() {
        String data[][] = null;
        String colu[] = new String[]{"Index", "Customer Name", "TP", "Email", "Date", "Branch", "Block No", "Id"};
...
//        tblGrid.getColumnModel().getColumn(8).setCellRenderer(rightRenderer);
        ...
        TableColumn coloumn7 = tblGrid.getColumnModel().getColumn(7);
        coloumn7.setMinWidth(0);
        coloumn7.setPreferredWidth(0);
        coloumn7.setMaxWidth(0);
    ...
    private void initComponents() {
        ...
        block_select = new javax.swing.JComboBox<>();
        ...
        customer_name.setFont(new java.awt.Font("Cambria Math", 1, 12)); // NOI18N
        jPanel1.add(customer_name, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 60, 240, 25));
        ...
        jPanel1.add(branch_save_btn, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 80, 150, 25));

        jLabel3.setFont(new java.awt.Font("Cambria Math", 1, 12)); // NOI18N
        jLabel3.setText("Customer Name");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 60, 140, 20));
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 100, 100, 20));

        block_select.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select" }));
        block_select.setToolTipText("");
        jPanel1.add(block_select, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 100, 240, -1));
        ...
        jPanel1.add(customer_tp_txt, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 100, 240, 25));
    ...
    public void search_data(){
     ShowGrid();
        ...
        String customers_name = customer_name.getText();
        String customer_tp = customer_tp_txt.getText();
        String branch = branch_select.getSelectedItem().toString();
        String block = block_select.getSelectedItem().toString();

        DefaultTableModel model = (DefaultTableModel) tblGrid.getModel();

        try {
            ResultSet set = customerData.searchCustomers(customers_name, customer_tp, branch, block);
            set.last();
            set.beforeFirst();
            int x = 1;
            while (set.next()) {
//                String catagary_name = set.getString("catagary_name");
                ...
                model.addRow(new Object[]{x++, set.getString("customer_name"), set.getString("customer_tp"), set.getString("customer_email"), set.getString("date"), set.getString("branch"), set.getString("block_no"), set.getString("id")});
            }
            set.close();
            set = null;

        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Catagary 01 Loading not complete " + e);
        }
    }
...
search_data();
    ...
    private javax.swing.JComboBox<String> block_select;
